...
<head>
    ...
    <title>saiful islam sohan personal portfolio </title>
...
<header>
    ...
    <a href="#" class="logo"> <span>saiful</span> islam </a>
...
<section class="home" id="home">
    ...
    <div class="content">
        ...
        <h3> i am <span> saiful islam </span> </h3>
...
<div class="row-1">
    ...
    <div class="content">
        <h3> my name is saiful islam & i am a font-end developer </h3>
...
<section class="contact" id="contact">
    ...
    <div class="icons-container">
        ...
        <div class="icons">
            ...
            <h3>my address</h3>
            <p>Dhaka, Narayanganj, sonagaon,  - 1440</p>
        </div>
    ...
    <div class="row">
        ...
        <form action="contact.php" method="POST">
            ...
            <input type="text" placeholder="name" class="box" name="c_name">
            <input type="text" placeholder="First_name" class="box" name="c_fname">
            <input type="text" placeholder="Last_name" class="box" name="c_lname">

           
            <input type="email" placeholder="email" class="box" name="c_email">
            <input type="number" placeholder="number" class="box" name="c_number">

            <textarea name="c_message" placeholder="message" id="" cols="30" rows="10"></textarea>

            <input type="submit" class="btn" value="send message">

        </form>

        <form action="view.php" method="post" id="new">
            <button class="extra"> view data</button>
...
<!-- footer section  -->
<footer class="footer"> created by <span> saiful islam </span> | all rights reserved! </footer>
